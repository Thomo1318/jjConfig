...
| Guide                                      | Description                                   |
| :----------------------------------------- | :-------------------------------------------- |
| **[Setup Guide](guides/setup.md)**         | Installation, prerequisites, and quick start. |
| **[User Guide](guides/usage.md)**          | Basic workflows, Repomix, and TUI usage.      |
| **[Contributing](guides/contributing.md)** | How to backup, test, and submit PRs.          |
| **[Troubleshooting](troubleshooting.md)**  | Solutions for common installation issues.     |

### ⚙️ Reference

- **[Aliases](reference/aliases.md)**: Full list of custom commands.
- **[Configuration](https://github.com/Thomo1318/jjConfig/blob/main/config.toml)**: Main configuration file (v1.1.0).
- **[Tasks & Roadmap](roadmap.md)**: Project status and future plans.
- **[Version History](changelog.md)**: Changelog and release notes.

---

## 🚀 Quick Start

For a fast setup, see the **[Setup Guide](guides/setup.md)**.
...
Contributions are welcome! Please read the **[Contributing Guide](guides/contributing.md)** for details on our "Golden Workflow" and code standards.
